  ...
  return (
    ...
    onSubmit={
      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
        ...
        {state === 'OTP'
        ?<button onClick={triggerOtp} className='bg-primary text-white w-full py-2 my-2 rounded-md text-base hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50'>Send OTP!!</button>
        : '' }
        {(state === 'Reset') ?
        <button onClick={triggerResetOtp} className='bg-primary text-white w-full py-2 my-2 rounded-md text-base hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-primary focus:ring-opacity-50'>Send OTP!!</button>
      :''}
