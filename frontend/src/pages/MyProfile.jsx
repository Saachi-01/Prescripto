...
const MyProfile = () => {
    const data = [
        { name: 'January', patients: Math.floor(Math.random() * (9 - 0 + 1)) + 0 },
        { name: 'February', patients:  Math.floor(Math.random() * (9 - 0 + 1)) + 0 },
        { name: 'March', patients: Math.floor(Math.random() * (9 - 0 + 1)) + 0 },
        { name: 'April', patients: Math.floor(Math.random() * (9 - 0 + 1)) + 0 },
        { name: 'May', patients: Math.floor(Math.random() * (9 - 0 + 1)) + 0 },
      ];
